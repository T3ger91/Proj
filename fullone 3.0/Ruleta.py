...
def Ruleta(budget):
    ...
    while True:
            ...
            if term >= 1:
                ...
                z = z + 1
                sentences = [
                    "Welcome to a rulet game! This game you can not skip! What tipe of bets system you want to play: Inside bets, Outside bets or Random bets?\n",
                ...
                try:
                    ...
                    if x == "inside bets" or x == "inside bet" or x == "inside":
                        ...
                        slow_print(f"Your total budget is now {budget}. ")
                        while True:
                        ...
                        slow_print(f"From now on your total budget is {budget}. ")
                        while True:
                            slow_print("Do you want play again? Yes or No\n")
                            y = input().lower()
